...
○ 프로그램에서 발생하는 오류(Error)는
   ...
   ② 프로그램을 실행하는 과정에서 발생되는 런타임 오류(Error) 로
	...
	==> 개발자가 이런 예외 사항이 발생할 경우를 미리 예측하여
	    적절히 대흥하기 위한 절차를 구현하도록 문법을 정리해 놓은 것.
		예. 외. 처. 리
