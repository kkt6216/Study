...
○ 상속(Inheritance)이란
   ...
   즉, 상속은 객체를 좀더 쉽게 만들 수 있는
   고수준의 재사용성(reusablitiy)으 확보하고
   객체 간의 관계를 구성함으로써
...
class SuperTest111
{
	protected double area;		//-- protected =  99퍼센트 상속클래스 사용 염두
...
{
	/*
	protected double area;		//-- protected =  99퍼센트 상속클래스 사용 염두    -- 부모로부터 상속받은 area
	...
	SuperTest111()
	{
		System.out.println("Super Class ...");										-- 부모로부터 상속받은
	}
