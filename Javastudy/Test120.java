...
※ 인터페이스의 구현
   ...
   이러한 기능을 수행하는 것이 『implements』 에약어이다.
...
//	  ↓
// 클래스
// 두 인터페이스(ADemo,  BDemo)를 상속받은 인터페이스를 구현한 후 모든 메소드를 재정의 한 클래스
...
public class Test120
{
	...
	{
		// 두 개의 인터페이스(ADemom, BDemo)를 상속받은
		// 인터페이스(CDemo)를 구현하고
		// 해당 인터페이스(CDemo)의 메소드 뿐 아니라
		// 상속받은 인터페이스(ADemo, BDemo)의 모든 메소드를 재정의(Ovderriding)한
