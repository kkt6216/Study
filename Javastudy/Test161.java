...
public class Test161
{
	...
	public static void main(String[] args)
	{
		...
		// 벡터 자료구조 v의 전체 출력 요소
		System.out.print("전체 출력 요소 출력:");
		for (String str : v )
			System.out.print(str + " ");

		System.out.println();
		//--==>> 전체 출력 요소 출력:검정 노랑 초록 파랑 빨강 연두
		...
		// 『v.contains(s)』
		//-- 벡터 자료구조 v 에 찾고자 하는 s 가 포함되어 있는지의 여부 확인
		...
		// 찾아서 삭제한 후 전체 요소 출력
		System.out.print("삭제 후 전제 요소 출력 : ");
		for(String str : v)
			System.out.print(str + " " );
		System.out.println();
		//--==>> 삭제 후 전제 요소 출력 : 검정 초록 파랑 빨강 연두
